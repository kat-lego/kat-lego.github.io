...
const config = {
  ...
  tagline: 'finding out what is behind the screen',
  ...
  organizationName: 'kat-lego', // Usually your GitHub org/user name.
  projectName: 'kat-lego.github.io', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/kat-lego/kat-lego.github.io/tree/main',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        //   },
          ...
          {
            href: 'https://github.com/kat-lego',
            label: 'GitHub',
            position: 'right',
          },
        ],
